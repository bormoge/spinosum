...
For now this repository only has three scripts to help me collect URLs from GitHub, GitLab, and Codeberg.
...
3. The script should activate automatically every time you access GitHub / GitLab / Codeberg.

## Usage
1. Go to GitHub / GitLab / Codeberg.
2. Once there, you will see a red button.
3. Click the red button to download any GitHub / GitLab / Codeberg repository you have already visited in your current browser session. By default, the file will have a [.org](https://orgmode.org/) extension.
